...
class EmailService {
    ...
    public function sendEmailPHPMailer($to, $subject, $body, $fromName = null) {
        ...
        try {
            ...
            // CRITICAL: Disable SMTPUTF8 BEFORE isSMTP() to avoid "Server does not support SMTPUTF8" error
            // PHPMailer uses UseSMTPUTF8 property (public property, no reflection needed)
            $mail->UseSMTPUTF8 = false;
            
            // SMTP configuration (must come AFTER UseSMTPUTF8 setting)
            $mail->isSMTP();
