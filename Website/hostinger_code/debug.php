...
try {
    ...
    $phpmailerPaths = [
        __DIR__ . '/php-backend/vendor/PHPMailer/src/PHPMailer.php',
        __DIR__ . '/php-backend/vendor/PHPMailer/PHPMailer/src/PHPMailer.php',
        __DIR__ . '/php-backend/vendor/PHPMailer/PHPMailer/PHPMailer.php',
        __DIR__ . '/php-backend/vendor/phpmailer/phpmailer/src/PHPMailer.php',
    ];
    ...
    foreach ($phpmailerPaths as $path) {
        if (file_exists($path)) {
            ...
            // Also load SMTP.php and Exception.php
            ...
            if (class_exists('PHPMailer\PHPMailer\PHPMailer') && 
                ...
                echo "⚠ PHPMailer file exists but classes not fully loaded\n";
            }
            break;
        }
    }
    ...
    if ($phpmailerInstalled && class_exists('PHPMailer\PHPMailer\PHPMailer')) {
        try {
            $mail = new PHPMailer\PHPMailer\PHPMailer(true);
